...
$upcoming_income = $upcoming_row['upcoming_income'] ?? 0;
?>
    ...
    <div class="col-span-5 p-4">
        ...
        <div class="bg-gray-50 p-4 rounded-lg shadow-md mb-4 flex items-center">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-green-600">Rs. <?php echo number_format($total_income); ?></p>
            </div>
        </div>
        ...
        <div class="bg-gray-50 p-4 rounded-lg shadow-md flex items-center">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-red-600">Rs. <?php echo number_format($upcoming_income); ?></p>
            </div>
        </div>
    ...
    <script>
        ...
        var incomeChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Income (Rs)',
                    data: [<?php echo $total_income; ?>, <?php echo $upcoming_income; ?>],
